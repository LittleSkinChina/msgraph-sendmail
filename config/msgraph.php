...
return [
    ...
    /**
     * The user's ID (can be UUID or userPrincipalName) which emails should be sent from
     */
    'mailSender' => env('MSGRAPH_MAIL_SENDER'),

    /**
     * Run in debug mode (this enables transportation logs)
     */
    'debug' => env('MSGRAPH_MAIL_DEBUG', false),
];
